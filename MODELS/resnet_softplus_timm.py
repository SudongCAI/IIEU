...
class BasicBlock(nn.Module):
    ...
    def __init__(
            ...
            reduce_first=1, dilation=1, first_dilation=None, act_layer=nn.Softplus, norm_layer=nn.BatchNorm2d,
...
@register_model
def softplus_resnet14(pretrained=False, **kwargs):
    """
    """
    model_args = dict(block=Bottleneck, layers=[1, 1, 1, 1],  **kwargs)
    return build_model_with_cfg(
        ResNet, 'softplus_resnet14', default_cfg=default_cfg['resnet14'],
        pretrained=pretrained, **model_args)



@register_model
def softplus_resnet26(pretrained=False, **kwargs):
    """
    """
    model_args = dict(block=Bottleneck, layers=[2, 2, 2, 2],  **kwargs)
    return build_model_with_cfg(
        ResNet, 'softplus_resnet26', default_cfg=default_cfg['resnet26'],
        pretrained=pretrained, **model_args)
